Vue.component('register-step-1', {
    ...
    <div class="row justify-content-center p-4">
        <div class="col-auto">
            <img style="height: 100px" src="https://s3-ap-southeast-1.amazonaws.com/pam4-sansiri/ecom/public/1Yc6LIpv5eSeQcMnWVpHOGghgvp.jpg">
        </div>
        <div class="col-6">
            <div>
                <h2>Easy Will</h2>
        ...
        <div class="col-auto">
            <a href="#" @click="(e)=>{e.preventDefault();$emit('reset')}">ดูแพ็คเกจอื่น</a>
        </div>
    </div>
    <hr>
    <div class="row px-5 py-4">
        <div class="col d-flex align-items-center position-relative px-0">
            <div class="step-circle text-center p-1 d-flex flex-column justify-content-center" style="height: 60px;width: 60px; border-radius: 50%; background-color: #f6dc1a; z-index: 1">
                <h6 style="line-height: 1">Step</h6>
                <h3 style="font-weight: bolder; line-height: 0.5">1</h3>
            </div>
            <div class="step-detail flex-grow-1 d-flex align-items-center justify-  content-center" style="background-color: #f9ea7d; width: 95%; height: 65%;position: absolute; right: -5%; padding-left: 7%">
        ...
        <div class="col d-flex align-items-center position-relative px-0 text-white">
            <div class="step-circle text-center p-1 d-flex flex-column justify-content-center" style="height: 60px;width: 60px; border-radius: 50%; background-color: #9a9a9b; z-index: 1">
                <h6 style="line-height: 1">Step</h6>
                <h3 style="font-weight: bolder; line-height: 0.5">2</h3>
            </div>
            <div class="step-detail flex-grow-1 d-flex align-items-center justify-content-center" style="background-color: #d6d6d7; width: 95%; height: 65%;position: absolute; right: -5%; padding-left: 7%">
                <div class="w-100 px-4 pb-1 text-center" style="overflow-wrap: break-word">
